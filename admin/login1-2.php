...
<input type="button" onclick="location.href='admin_edit.php'" value="商品の編集"><br>
<input type="button" onclick="location.href='admin_add.php'" value="商品の追加">